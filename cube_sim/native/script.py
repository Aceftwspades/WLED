...
def write_helpers(path=None):
    ...
    text = ("// GENERATED by cube_sim/native/script.py from native/nodedefs.py HELPERS - do not edit.\n"
            "// The helper functions the WLED Effect Studio's generated effects carry, for the\n"
